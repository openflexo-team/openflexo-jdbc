...
/**
 * A {@link AbstractFetchRequest} used to perform a JDBC SQL-query
 * 
 * @author sylvain
 *
 */
...
public interface AbstractPerformSQLQuery<AT>
	...
	public static abstract class AbstractPerformSQLQueryImpl<AT>
		...
		private static final Logger logger = Logger.getLogger(AbstractPerformSQLQueryImpl.class.getPackage().getName());
		...
		@Override
		public List<HbnFlexoConceptInstance> performExecute(RunTimeEvaluationContext evaluationContext) {
