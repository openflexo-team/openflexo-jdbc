...
/**
 * A parameter used to instanciate a new {@link HbnVirtualModelInstanceResource}
 * 
 * @author sylvain
 *
 */
...
public interface CreateHbnResourceParameter extends BehaviourParameter<CreateHbnResource> {
	...
	public static class ValueBindingMustBeValid extends BindingIsRequiredAndMustBeValid<CreateHbnResourceParameter> {
		public ValueBindingMustBeValid() {
			super("'value'_binding_is_required_and_must_be_valid", CreateHbnResourceParameter.class);
		}

		@Override
		public DataBinding<?> getBinding(CreateHbnResourceParameter object) {
			return object.getValue();
		}

		@Override
		public ValidationIssue<BindingIsRequiredAndMustBeValid<CreateHbnResourceParameter>, CreateHbnResourceParameter> applyValidation(
				CreateHbnResourceParameter object) {
