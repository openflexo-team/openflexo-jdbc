...
public interface HbnObjectActorReference extends ActorReference<HbnFlexoConceptInstance> {
	...
	abstract class HbnObjectActorReferenceImpl extends ActorReferenceImpl<HbnFlexoConceptInstance> implements HbnObjectActorReference {

		private static final Logger logger = FlexoLogger.getLogger(HbnObjectActorReference.class.getPackage().toString());

		// private boolean isLoading = false;

		private HbnFlexoConceptInstance modellingElement;

		@Override
		public void setModellingElement(HbnFlexoConceptInstance object) {
