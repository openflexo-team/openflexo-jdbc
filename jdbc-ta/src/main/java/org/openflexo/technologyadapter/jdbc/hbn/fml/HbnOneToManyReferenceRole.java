...
/**
 * A role specific to Hibernate technology (FMLJDBCModelSlot) allowing to access a collection of referenced objects in an external table
 * 
 * @author sylvain
 *
...
@XMLElement
public interface HbnOneToManyReferenceRole extends FlexoConceptInstanceRole {

	@PropertyIdentifier(type = String.class)
	String DESTINATION_KEY_COLUMN_NAME_KEY = "destinationKeyColumnName";

	@Getter(DESTINATION_KEY_COLUMN_NAME_KEY)
	@XMLAttribute
	String getDestinationKeyColumnName();

	@Setter(DESTINATION_KEY_COLUMN_NAME_KEY)
	void setDestinationKeyColumnName(String destinationKeyColumnName);

	public static abstract class HbnToManyReferenceRoleImpl extends FlexoConceptInstanceRoleImpl implements HbnOneToManyReferenceRole {
